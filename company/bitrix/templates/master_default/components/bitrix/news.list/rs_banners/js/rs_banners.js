        ...
        adjustBlocks: function() {
            ...
            $banners.each($.proxy(function(key, banner) {
                ...
                for (i = $infoBlocksChildren.length - 1; i >= 0; --i)
                {
                    ...
                    {
                        if (
                            $element.hasClass('js-banners-title')
                            && !!$infoBlocks.find('.js-banners-before-title')
                            && $infoBlocks.find('.js-banners-before-title').is(':not(:hidden)') == true
                        )
                        {
                            $infoBlocks.find('.js-banners-before-title').hide();
